        ...
        {!loadingData ?
          <View>
            <HorizontalScrollView horizontal={true} showsHorizontalScrollIndicator={false}>
              ...
              <RadioButton
                label="Completadas"
                checked={selected === 'Completadas'}
                onPress={() => handleFilter('Completadas')}
              />

              <RadioButton
                label="Pendientes"
                checked={selected === 'Pendientes'}
                onPress={() => handleFilter('Pendientes')}
              />

              <RadioButton
                label="Rechazadas"
                checked={selected === 'Rechazadas'}
                onPress={() => handleFilter('Rechazadas')}
              />
